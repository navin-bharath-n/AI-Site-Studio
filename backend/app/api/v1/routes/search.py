...
async def search_templates(
    ...
    - **semantic**: If true, uses OpenAI embeddings + Qdrant for semantic similarity search.
    ...
    if semantic:
        return await service.semantic_search(q, limit=page_size, category_filter=category)
    else:
